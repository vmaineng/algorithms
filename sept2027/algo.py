def HQ9(code):
    ...
    #if H, do this
    #ifQ, do this
    #if 9, return the song
    #if everything else, return nothing
    ...
    #return a string where a and b switch places, leave c untouched
    #ex: 'abc' => 'bac'
    
    
    #do nested loops, if it hits an a or b
    #swap them
    #return new sting
...
class Solution:
    ...
    def sortColors(self, nums: List[int]) -> None:
        ...
        #return the list sorted without using nums.sort()
